/*Exercício: Gerenciador de Turma
Objetivo: Criar um programa para gerenciar uma pequena turma de alunos. O programa irá cadastrar vários alunos (em um vetor de estruturas), calcular a média de cada um e, em seguida, permitir ao usuário buscar um aluno pelo nome para ver seu relatório.*/
